 ...
 */
final class Version20190905203125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE secure_action CHANGE token token VARCHAR(32) NOT NULL, CHANGE action action JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE secure_action CHANGE token token VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE action action LONGTEXT NOT NULL COLLATE utf8mb4_bin');
