 ...
 */
final class Version20190905202046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE secure_action (id INT AUTO_INCREMENT NOT NULL, creation_date DATETIME NOT NULL, expiration_date DATETIME NOT NULL, token VARCHAR(64) NOT NULL, validated TINYINT(1) NOT NULL, action JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE secure_action');
