 ...
 */
final class Version20190905203740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE secure_action CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE action action JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE secure_action CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE action action LONGTEXT NOT NULL COLLATE utf8mb4_bin');
