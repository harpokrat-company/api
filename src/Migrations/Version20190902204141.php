 ...
 */
final class Version20190902204141 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin, CHANGE email_validation_date email_validation_date DATETIME NOT NULL, CHANGE email_validation_mail_sent_date email_validation_mail_sent_date DATETIME NOT NULL, CHANGE email_validation_code email_validation_code VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
